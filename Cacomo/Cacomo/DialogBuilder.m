...
+(DialogFlow *)cardsAndStones:(CardLayer *)cardLayer playBuilder:(PlayBuilder *)playBuilder cardLookup:(NSDictionary *) lookup {
    ...
    CCSprite *dCircle = [[CCSprite alloc] initWithFile:@"small-circle.png" rect:CGRectMake(0, 0, 35, 35)];
    dCircle.position = ccp([SpritePositions colPosition:0 size:8] - 15, [SpritePositions rowPosition:3 size:8]);
    CCSprite *threeCircle = [[CCSprite alloc] initWithFile:@"small-circle.png" rect:CGRectMake(0, 0, 35, 35)];
    threeCircle.position = ccp([SpritePositions colPosition:2 size:8], [SpritePositions rowPosition:0 size:8] + 15);
...
+(CCSprite *)buildTriangle:(int)row :(int)col size:(int)size {
    CCSprite *tri = [[CCSprite alloc] initWithFile:@"triangle.png" rect:CGRectMake(0, 0, 35, 35)];
