...
-(void)renderPoints:(Team *) team position:(int) pos {
    ...
    CCLabelTTF *score = [CCLabelTTF labelWithString:name fontName:@"Arial-BoldMT" fontSize:16];
...
-(void)renderFinalScore {
    ...
    CCLabelTTF *titleCenterTop = [CCLabelTTF labelWithString:victory fontName:@"Arial-BoldMT" fontSize:42];
    ...
    backdrop.position = ccp(160,300);
    [self addChild:backdrop];
    self.isDone = true;
    
    titleCenterTop.position = ccp(160, 345);
