...
-(void)renderAboutText {
    ...
    CGSize size = CGSizeMake(winSize.width - 20, winSize.height - 20);
    CCLabelTTF *label = [CCLabelTTF labelWithString:text dimensions:size hAlignment:UITextAlignmentLeft fontName:@"Arial-BoldMT" fontSize:42];;
