...
-(CCLabelTTF *)textSprite:(int)x :(int)y {
    CGSize size = CGSizeMake(575, 315); // 580 315
    CCLabelTTF *text = [CCLabelTTF labelWithString:self.text dimensions:size hAlignment:NSTextAlignmentCenter fontName:@"Arial-BoldMT" fontSize:48];
...
-(CCMenu *)okCancelSprite:(int)x :(int)y okBlock:(void (^)(id))okBlock cancelBlock:(void (^)(id))cancelBlock {
    ...
    CCMenuItemSprite *item2 = [CCMenuItemSprite itemWithNormalSprite:[CCSprite spriteWithFile:@"cancel.png"] selectedSprite:[CCSprite spriteWithFile:@"cancelAlt.png"] block:cancelBlock];
